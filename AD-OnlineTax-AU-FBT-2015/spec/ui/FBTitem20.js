...
describe('1 TaxOnlineTest', function () {
...
it('13 Tax - Previous Postal Address', function (done) {
  client
    .withAngular()
    .setValue('body > div.container.onlinetax > form > div > div:nth-child(16) > div.row > div > input', true)
     ///xpath- html/body/div[1]/form/div/div[16]/div[3]/div/input
    //css path -> body > div.container.onlinetax > form > div > div:nth-child(16) > div.row > div > input
    .getValue('[id="input.ReportingParty.Employer.Previous.AddressDetails.Line1.Text"]', function(err, value) {
             //#input\2e ReportingParty\2e Employer\2e Previous\2e AddressDetails\2e Line1\2e Text
        mystr = value;
        //.toString().trim();
      ...
      client.setValue('[id="input.ReportingParty.Employer.Previous.AddressDetails.Line1.Text"]',myaddr1) 
      //Enter Addressline1
      }
      })
    .getValue('[id="input.ReportingParty.Employer.Previous.AddressDetails.LocalityName.Text"]', function(err, value) {
        mystr = value;
        //.toString().trim();
      ...
      client.setValue('[id="input.ReportingParty.Employer.Previous.AddressDetails.LocalityName.Text"]',mysuburb1) 
      // Enter the suburb
      }
      })
      .getValue('[ng-model="form.fields[\'ReportingParty.Employer.Previous.AddressDetails.StateOrTerritory.Code\'].value"]', function(err, value) {
        mystr = value;
        //.toString().trim();
      ...
      client.selectByValue('[ng-model="form.fields[\'ReportingParty.Employer.Postal.AddressDetails.StateOrTerritory.Code\'].value"]', mystate1) 
      //Select the state
      }
      })

    .getValue('[id="input.ReportingParty.Employer.Previous.AddressDetails.Postcode.Text"]', function(err, value) {
        mystr = value;
        //.toString().trim();
      ...
      client.setValue('[id="input.ReportingParty.Employer.Postal.AddressDetails.Postcode.Text"]',myPostcode1) 
      //Enter the Postal code
      }
      })
      .pause(mywait)
